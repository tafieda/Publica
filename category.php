...
$query=mysqli_query($con,"select id,CategoryName from tblcategory where id='$catid'");
...
?>
  ...
  <title>Publica - <?php echo htmlentities($row['CategoryName']);?> <?php }?></title>
  <meta content="Publica is an online multi-media organisation with headquarters in Kano State, Nigeria."
    name="description">
  <meta content="Entertainment, tech, business, News, trending, media, gossip, celebrities, references, tips, videos" name="keywords">
           ...
           <h3 class="category-title">Category:  <?php echo htmlentities($row['category']);?></h3>
            <div class="d-md-flex post-entry-2 half">
              ...
              <div>
                ...
                <h3><a href="single.php?nid=<?php echo htmlentities($row['pid'])?>"><?php echo htmlentities($row['posttitle']);?></a></h3>
                <p>
                          <?php 
$pt=$row['postdetails'];
