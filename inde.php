...
<body>
  <section class="header-box fixed-bar ">
    ...
    <ul class="top-nav">
      <a href="index.php">
        <li class="nav" id="c-color"> Home <i class="fa fa-circle" style="font-size: 8pt;  "></i></li>
      </a>
      <a href="category.php?catid=2">
        <li class="nav"> Politics</li>
      </a>
      <a href="category.php?catid=3">
        <li class="nav">Sports</li>
      </a>
      <a href="category.php?catid=7">
        <li class="nav"> Business</li>
      </a>
      <a href="category.php?catid=5">
        <li class="nav"> Entertainment</li>
      </a>
      <a href="category.php?catid=6">
        <li class="nav"> Trending</li>
      </a>
      <a href="category.php?catid=9">
        <li class="nav"> Health</li>
      </a>
  ...
  <div id="mySidenav" class="sidenav">
    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()"><i
        style="color: red; float: right; font-size: 50pt;">&times;</i></a>
...
?>
        <h6 style="border-top: 2px solid white; color: grey;  font-family: Berlin Sans FB;">
          <svg viewBox="0 0 512 512" class="svg-clock">
            <!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
            <path
              d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z" />
            </svg> <?php echo time_elapsed_string($row['postingdate']);?>

        </h6>
        <div class="card mb-4">
          <img class="postimgtopt" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>"
...
?>
        <h6 style="border-top: 2px solid #aaa; color: grey;  font-family: Berlin Sans FB;">
          ...
          <span style="float:right"><i>Category : </i> <a style="color:#113277"
              href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><?php echo htmlentities($row['category']);?></a>
          </span>
        </h6>
        <div class=" postimgtop-con">
          <img class="postimgtop" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>"
            alt="<?php echo htmlentities($row['posttitle']);?>">
...
?>
      ...
      <h6 style="border-top: 2px solid white; color: grey;  font-family: Berlin Sans FB;"><svg viewBox="0 0 512 512"
          class="svg-clock">
          <!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
          <path
            d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z" />
      ...
      <div class="imgprops" style="height:auto;">
        <div
          style="height:62px; background-color: #232937; overflow:hidden; box-sizing: border-box; border: 1px solid #282E3B; border-radius: 4px; text-align: right; line-height:14px; block-size:62px; font-size: 12px; font-feature-settings: normal; text-size-adjust: 100%; box-shadow: inset 0 -20px 0 0 #262B38;padding:1px;padding: 0px; margin: 0px; width: 100%;">
